...
os.system('ghdl -i -g -Wno-hide -O3 --std=08 --workdir=work *.vhd')
os.system('ghdl -m -g -Wno-hide -O3 --std=08 --workdir=work ' + top)

os.system('ghdl -r -g -Wno-hide -O3 --std=08 --workdir=work ' + top + param + ' --wave=work/' + top + '.ghw' + ' --vcd=work/' + top + '.vcd' +' --stop-time=' + stoptime + ' --ieee-asserts=disable') 
if args.g == True:
